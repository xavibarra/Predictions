...
const isAppleDevice = /Mac|iPhone|iPad|iPod/.test(navigator.userAgent) && !/Windows/.test(navigator.userAgent);
    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-logo">
          <div className="auth-logo-icon"><IconTrophy size={16} /></div>
          <span className="auth-logo-text">Predictions <strong>· 26</strong></span>
        </div>
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <div className="auth-field">
            ...
            <input className="auth-input" type="text" placeholder="Tu nombre en el ranking" value={username} onChange={e => setUsername(e.target.value)} required />
          </div>
          <div className="auth-field">
        ...
        <p className="auth-footer">
          {t("auth_has_account")} <Link to="/login">{t("auth_login_link")}</Link>
        </p>
      </div>
    </div>
  );
